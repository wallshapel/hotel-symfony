 ...
 */
final class Version20250323014131 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE room (id INT AUTO_INCREMENT NOT NULL, hotel_id INT NOT NULL, number VARCHAR(50) NOT NULL, type VARCHAR(50) NOT NULL, capacity INT NOT NULL, price DOUBLE PRECISION NOT NULL, status VARCHAR(50) NOT NULL, INDEX IDX_729F519B3243BB18 (hotel_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
